...
subtitle: "by Tamar R Makin Andjean-Jacques Orban Dexivry | Presented by Melanie Desroches"
format:
    revealjs:
        slide-number: true
        preview-links: true
...
- If many variables that are included do not correlate with the dependent variable, there is likely a multiple comparisons issue.
