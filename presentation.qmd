...
- By not clearly defining and using the correct units of analysis, this can increase the degrees of freedom and therefore 
increase the statistical power. Thus, it is easier to observe falsely significant results
...
- Compare the number of independent variables and the number of analyses performed. If many variables that are included 
do not correlate with the dependent variable, there is likely a multiple comparisons issue.
...
but to what extent there is an effect. Examples of reporting effect size are Cohen’s d, Odds ratio, or Pearson’s correlation coefficient
- Always be mindful of how you interpret non-significant results. Just because you fail to reject the null hypothesis 
